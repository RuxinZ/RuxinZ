<h1>Hi, I'm Carolyn. <img src="https://user-images.githubusercontent.com/1303154/88677602-1635ba80-d120-11ea-84d8-d263ba5fc3c0.gif" width="28px" height="28px" alt="hi">
</h1>
<h3><strong>I'm a full-stack software engineer </strong></h3>

- Currently, I work as a Software Engineer at [Latitude](https://lumiere.is/) on the team responsible for building [Lumiere](https://lumiere.is/platform/). Lumiere is a media platform that combines natural language processing, video data analytics, and AI insights to help media and tech firms enhance content and engage audiences.
- When I'm not coding, I like hiking :mountain:, nature photography :camera_flash:, reading :books:, and learning languages :writing_hand:.
